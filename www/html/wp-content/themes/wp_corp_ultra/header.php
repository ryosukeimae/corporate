...
<!-- End Google Tag Manager -->
  ...
  <meta name="description" content="<?php if( has_excerpt() ) {
          ...
          echo "株式会社ULTRAは、”「働く」を、もっと「おかね」につなげる”を目指して、ultra pay カードの発行を中心にFintechを追求していきます。";
        } ?>">
  <meta name="keywords" content="ultra,ULTRA,プリペイドカード,ウルトラ,カード,スマホアプリ,Fintech,フィンテック"/>
  <link rel="canonical" href="https://corp.ultra-pay.co.jp/">
  ...
  <div class="sp">
    ...
    <nav class="header_nav">
      <ul class="header_nav_list">
        ...
        <li>
          <a href="<?php echo home_url(); ?>#home_sec_message">
            メッセージ
          </a>
        </li>
        <li>
          <a href="<?php echo home_url(); ?>#home_sec_company">
            会社概要
          </a>
        </li>
        <li>
          <a href="https://ultra-pay.co.jp/" target="_blank">
            サービス
          </a>
        </li>      
      </ul>
    ...
    <div class="main_header">
      <div class="main_header_wrap">
        ...
        <nav>
          <ul class="header_nav_list">
            <li>
              <a  <?php if(is_home() || is_front_page()):?> class="current"<?php endif;?> href="<?php echo home_url(); ?>">
                 トップ
              </a>
            </li>
            <li>
